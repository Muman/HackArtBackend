...
- *Always* have quiz coverage for new features (or regression quizs for bug fixes), and *never* break existing quizs
...
Dependencies for building from source and running quizs:
...
* `grunt`: Perform a normal build, runs jshint and karma quizs
* `grunt build`: Perform a normal build
* `grunt dist`: Perform a clean build and generate documentation
* `grunt dev`: Run dev server (sample app) and watch for changes, builds and runs karma quizs on changes.
