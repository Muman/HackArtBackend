...
Moreover, if your pull request contains JavaScript patches or features, you must include [relevant unit quizs](https://github.com/twbs/bootstrap/tree/master/js/quizs). All HTML and CSS should conform to the [Code Guide](https://github.com/mdo/code-guide), maintained by [Mark Otto](https://github.com/mdo).
